...
<header>
    <div class="container-fluid bg-primary py-3 d-none d-md-block">
        <div class="container">
            <div class="row">
                <div class="col col-sm-4 col-md-4 col-lg-2 col-xl-4 text-center text-lg-left mb-2 mb-lg-0">
                ...
                <div class="col col-sm-4 col-md-4 col-lg-6 col-xl-4 text-center text-lg-right ">
                    <div class="d-inline-flex align-items-center">
                ...
                <div class="col col-sm-4 col-md-4 col-lg-4 col-xl-4 text-center text-lg-reght">
                    <div class="d-inline-flex align-items-center">
                        <div class="buttons">
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                <a href="index.html" class="navbar-brand d-block d-lg-none">
                    <h1 class="text-primary"><span class="text-secondary">Heladitos</span>Gourmet</h1>
                </a>
