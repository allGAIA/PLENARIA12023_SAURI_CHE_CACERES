...
<body>
    ...
    <form class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-6 p-3 m-auto" method="POST">
         <?php
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
             ...
             <input type="number" class="form-control" id="Cantidad" name="Cantidad" min="1" placeholder="Ingrese la cantidad de paletas">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Fecha de movimiento</label>
             <input type="date" class="form-control" id="Fec_mov" name="Fec_mov" max="<?php echo date('Y-m-d'); ?>" placeholder="Ingrese la fecha de movimiento">
         </div>
         <div class="mb-3">
                ...
                <table class="table table-striped table-hover">
                    <thead class=bg-info>
                        <tr class="fila">
                            ...
                            <th class="text-center"  scope="col">ID de venta</th>
                            <th class="text-center"  scope="col">Sabor</th>
                            <th class="text-center"  scope="col">Cantidad</th>
                            <th class="text-center"  scope="col">Fecha de movimiento</th>
                    ...
                    <?php
                            ...
                            <tr>
                                <td class="text-center" ><?= $datos->ID_venta ?></td>
                                <td class="text-center" ><?= $datos->sabor ?></td>
                                <td class="text-center" ><?= $datos->Cantidad ?></td>
                                <td class="text-center" ><?= $datos->Fec_mov ?></td>
                                <td class="text-center" ><?= $datos->Tipo_mov ?></td>
