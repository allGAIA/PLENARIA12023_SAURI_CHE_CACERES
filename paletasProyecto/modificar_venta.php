    ...
    <form class="col-4 p-3 m-auto" method="POST" action="php/modificar_venta_post.php">
        ...
        while ($datos=$sql->fetch_object()) {
         ...
         <div class="mb-3">
             ...
             <input type="number" class="form-control" id="Cantidad" name="Cantidad" min="1" placeholder="Ingrese la cantidad de paletas" value="<?= $datos->Cantidad ?>">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Fecha de movimiento</label>
             <input type="date" class="form-control" id="Fec_mov" name="Fec_mov" max="<?php echo date('Y-m-d'); ?>" placeholder="Ingrese la fecha de movimiento" value="<?= $datos->Fec_mov ?>">
         </div>
