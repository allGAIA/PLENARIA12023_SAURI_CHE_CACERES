...
<body>
    ...
    <form class="col-122 col-sm-10 col-md-8 col-lg-6 col-xl-6 p-3 m-auto" method="POST">
         <?php
         include "php/registro_usuarios.php";
         ?>
         <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="Nombre" name="Nombre" pattern="[A-Za-z]+" placeholder="Ingrese el nombre del usuario">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Apellido</label>
             <input type="text" class="form-control" id="Apellido" name="Apellido" pattern="[A-Za-z]+" placeholder="Ingrese el apellido del usuario">
         </div>
         ...
         <div class="mb-3">
             ...
             <input type="text" class="form-control" id="Contraseña" name="Contraseña" pattern="[A-Za-z0-9_-]{1,1000000}" placeholder="Ingrese la contraseña del usuario">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Fecha de nacimiento</label>
             <input type="date" class="form-control" id="Fec_nacimiento" name="Fec_nacimiento" max="<?php echo date('2005-m-d'); ?>" placeholder="Ingrese la fecha de nacimiento del usuario">
         </div>
                    ...
                    <tr>
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?= $datos->Fec_nacimiento ?></td>
