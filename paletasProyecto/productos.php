...
<body>
    ...
    <form class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-6 p-3 m-auto" method="POST">
         <?php
         include "php/registro_paletas.php";
         ?>
         <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Sabor</label>
                <input type="text" class="form-control" id="sabor" name="sabor" pattern="[A-Za-z]+" placeholder="Ingrese el sabor del producto">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Costo de producción</label>
             <input type="number" class="form-control" id="Costo" name="Costo" min="1" placeholder="Ingrese el costo del producto">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Precio</label>
             <input type="number" class="form-control" id="Precio" name="Precio" min="1" placeholder="Ingrese el precio del producto">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Precio a mayoreo</label>
             <input type="number" class="form-control" id="Precio_m" name="Precio_m" min="1" placeholder="Ingrese el precio a mayoreo del producto">
         </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-6 p-3 m-auto">
                ...
                <table class="table table-striped table-hover">
                    <thead class=bg-info>
                        <tr class="fila">
                            ...
                            <th class="text-center" scope="col">Sabor</th>
                            <th class="text-center" scope="col">Costo de producción</th>
                            <th class="text-center" scope="col">Precio</th>
                            <th class="text-center" scope="col">Precio a mayoreo</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                <td class="text-center"><?= $datos->ID_Paleta ?></td>
                                <td class="text-center"><?= $datos->sabor ?></td>
                                <td class="text-center"><?= $datos->Costo ?></td>
                                <td class="text-center"><?= $datos->Precio ?></td>
                                <td class="text-center"><?= $datos->Precio_m ?></td>
