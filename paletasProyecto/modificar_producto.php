    ...
    <form class="col-4 p-3 m-auto" method="POST" action="php/modificar_producto_post.php">
        ...
        while ($datos=$sql->fetch_object()) {
         ...
         <div class="mb-3">
             ...
             <input type="text" class="form-control" id="sabor" name="sabor" pattern="[A-Za-z]+" value="<?= $datos->sabor ?>">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Costo de producción</label>
             <input type="number" class="form-control" id="Costo" name="Costo"  min="1" value="<?= $datos->Costo ?>">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Precio</label>
             <input type="number" class="form-control" id="Precio" name="Precio" min="1" value="<?= $datos->Precio ?>">
         </div>

         <div class="mb-3">
             <label for="exampleInputEmail1" class="form-label">Precio al Mayoreo</label>
             <input type="number" class="form-control" id="Precio_m" name="Precio_m" min="1" value="<?= $datos->Precio_m ?>">
         </div>
         <?php 
        }
        ?>
